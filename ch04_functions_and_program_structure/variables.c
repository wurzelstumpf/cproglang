 ...
 *    Design
 *
 *        there will be 26 variables, all lower case from a-z
 *        setting variables:    a 3 =  corresponds to a = 3
 *                              3 a =  will also work
 *        variables can be used where numbers are used:
 *            a 3 +   or   a t %
 *        the variable representing the most recently printed
 *        value will be: $
 *
 */
#include <stdio.h>
